              ...
              <div>
                <div className="mb-6">
                  <select
                    ...
                    className="mt-2 block w-full rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 dark:bg-gray-950 dark:text-white dark:ring-gray-700 sm:text-sm sm:leading-6"
                    value={providerType || ""}
                  >
                      ...
                      <>
                        <div>
                          ...
                          <input
                            type="text"
                            id="issuer"
                            className="block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 dark:bg-gray-950 dark:text-white dark:ring-gray-700 sm:text-sm sm:leading-6"
